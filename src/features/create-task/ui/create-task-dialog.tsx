  ...
  return (
    ...
    >
      <section
        ...
        aria-modal="true"
        className="my-auto w-full max-w-[680px] overflow-hidden rounded-3xl bg-primary-0 shadow-[0_24px_80px_rgba(4,8,21,0.2)] max-[560px]:max-h-[calc(100dvh-24px)] max-[560px]:rounded-2xl"
        role="dialog"
      >
